...
public class AuthenticationController {
	...
	// Since access tokens are not shared across clients there is no 'deauthenticate',
	// rather the client simply deletes the access token it holds
	/**
	...
	// there is no 'revalidate' for an access token.  If the (non-confidential) 
	...
	public void signTermsOfUse(
			@RequestBody Session session) // TODO session must accept access token
			throws NotFoundException {
		authenticationService.signTermsOfUse(session);
	}

	/**
	 * API key is deprecated in favor of 'personal access token'
	 */
	@Deprecated
	...
	public @ResponseBody
	OAuthUrlResponse getAccessTokenViaOAuth2(
	...
	// TODO like validateOAuthSession but return access token
	...
	// TODO like createAccountViaOAuth2 but returns access token
